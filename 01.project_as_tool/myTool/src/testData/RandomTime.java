...
public class RandomTime {
    ...
    public Date generateRandomTime(Date date) throws ParseException {
    ...
    public static int testRandomRange(int[] valArr, int[] rateArr) {
        int[] result = new int[100];
        int rIdx = 0;
        for (int i = 0; i < valArr.length; i++) {
            for (int j = 0; j < rateArr[i]; j++) {
                result[rIdx + j] = valArr[i];
            }
            rIdx = rateArr[i];
        }
...
//            temp = Math.abs(rd.nextInt()%10);
//            temp = getRandomNum(20, 25);
//              temp = rd.nextInt(25);
//              temp = testRandomRange(valArr, rateArr);
    ...
    public static void main(String[] args) {
        testMethod();
//        int[] numArr = {30, 30, 30, 100};
//        System.out.println(getGCD(numArr));
//        List<Integer> list = getPrimeNumber(127);
//        for (int n : list) {
//            System.out.println(n);
//        }
//        System.out.println("=====================");
//        list = getPrimeNumber(55);
//        for (int n : list) {
//            System.out.println(n);
//        }
//        System.out.println("=====================");
//        list = getPrimeNumber(65);
//        for (int n : list) {
//            System.out.println(n);
//        }
    }
